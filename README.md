...
```sh
go get github.com/gapidobri/librespot-golang/librespot
```
...
```sh
go get -u github.com/gapidobri/librespot-golang
```
...
```sh
cd $GOPATH/src/github.com/gapidobri/librespot-golang
